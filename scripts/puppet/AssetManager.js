define( function()
{
	var AssetManager = function AssetManager( path )
	{
		...
		this.imageDirectories = [ { name : "mainMenu/", files : [ "mainBack.jpg", "loading.jpg", "newGame.png", "newGameH.png" ] },
								  { name : "plain/", files : [ "rayMap.png", "map.png" ] }, 
								  { name : "characters/", files : ["skull_run.png", "skull_attack.png"]},
								  { name : "ennemis/", files : [ "fantome.png" ] },
								  { name : "room/", files : [ "room.png" ] },
								  { name : "items/", files : [ "tp.png" ] },
								  { name : "girls/", files : [ "00.png", "01.png", "02.png", "03.png",
								  ...
								  { name : "backgrounds/", files : [ "background0.png",
																	"background1.png",
																	"background2.png",
																	"background3.png",
																	"background4.png",
